        ...
        <form class="row g-3 mt-3" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <div class="col-lg-6 d-flex">
                <div class="content px-4 my-auto ">
                    ...
                    <p class="parrafo-aval">a) Fondo SUTATESE.Es la aportación del Ahorrador. Se brinda de forma quincenal vía nómina del TESE con un mínimo de $100.00 
                    ...
                    <p class="parrafo-aval">b) Fondo Fijo Voluntario SUTATESE.Es una aportación voluntaria y sin plazo de término del AHORRADOR que consiste en un mínimo 
                    ...
                    <p class="parrafo-aval">c) Fondo Variable INVERSIONISTA.Es una opción de ahorro adicional a través de aportaciones extraordinarias que constituyen 
                    ...
                    <p class="parrafo-aval">Solo se permiten las aportaciones indicadas en este capítulo. </p>
            ...
            <div class="col-lg-6 d-flex">
                <div class="content mx-auto px-4 my-auto">
                    ...
                    <button type="button" class="btn btn-primary mt-4" style="width: 100%; height: 40px;" onclick=location.href="AhorroInversionista.php">Fondo Variable INVERSIONISTA</button>
