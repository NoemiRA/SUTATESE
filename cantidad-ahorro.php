        ...
        <div class="row g-0 h-100">
            <div class="col-lg-6 d-flex">
                <div class="content px-4 my-auto ">  <!-- Si se le queita el "my-auto" y se alinea con el titulo de la derecha -->
                    ...
                    <p class="nota-aval">NOTA: Leer el el Titulo Quinto "Aportaciones" del reglamento de la Caja de Ahorro.
                        </p>
            ...
            <div class="col-lg-6 d-flex">
                <div class="content mx-auto px-4 my-auto">
                    ...
                    <hr>
                    <div class="col-md-auto">
                        <label for="numEmpleado" class="form-label">Ingrese la cantidad a ahorrar en pesos mexicanos</label>
