    ...
    <?php
        if (isset($_SESSION['NumEmpleado5'])) {
            if(isset($_GET['pc']) && isset($_GET['cm']) && isset($_GET['q'])){
                ...
                // $consulta = $conn->query("INSERT INTO prestamo (IdPrestamo, NumEmpleado3, PoderCrediticio, IdTipoPrestamo1) VALUES('PRE1' , '" . $NumEmpleado. "' , '" . $PoderCred. "' , 'P3')");
            }
        ...
        <form class="row bg-light" method="post" action="" enctype="multipart/form-data"> 
            <div class="col-lg-5">
                ...
                <div class="form-group row mx-3 my-2 d-grid">
                    ...
                    <div class="col">
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" placeholder="Ejemp: 5" name="PlazoPago" id="input_cuotas" max="<?php echo $quincenasPago ?>">
                ...
                <div class="d-flex flex-column mb-3">
                    <div class="row m-3">
                        <button class="btn btn-danger" onclick="location.href='PoderCrediticio.php'">CANCELAR</button>
                    </div>
                    <!-- <div class="row m-3">
            ...
            <?php
                ...
                function alertsize(){
                    echo '<script> Swal.fire({icon: "error", title: "Error...", text: "¡La cantidad solicitada o las quincenas ingresadas son mayor a lo permitido!", showConfirmButton: true, confirmButtonText: "Cerrar"}).
                        then(function(result){
                            if(result.value){                   
                            }
                        });
                ...
                if (isset($_POST['Request'])) {
                    ...
                    if(empty($cantidadSolicitar) || empty($Plazopago)){
                        alertdata();
                    }else{
          ...
          <div class="d-flex flex-column col-md-5"> 
             <button type="button" class="btn btn-primary ms-3 me-4 mt-1" onclick="calcular();" name="calcular">¡CALCULAR!</button> 
        </div>
