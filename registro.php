                    ...
                    if (isset($_POST['Insert'])) {
                        ...
                        if (empty($employe) || empty($name) || empty($firstname) || empty($lastname) || empty($date) || empty($curp) || empty($rfc) || empty($dateIT) || empty($email) || empty($cellphone) || empty($phone) || empty($street) || empty($number) || empty($municipality) || empty($suburb) || empty($state) || empty($cp) || empty($division) || empty($experience) || empty($pexperience)) {
                            ...
                            if ($tipoN != "" && $tipoC != "" && $tipoP != "") {
                                ...
                                VALUES ('" . $employe . "' , UPPER('" . $name . "') , UPPER('" . $firstname . "') , UPPER('" . $lastname . "') , '" . $date . "' , UPPER('" . $curp . "') , UPPER('" . $rfc . "') , '" . $dateIT . "' , '" . $email . "' , '" . $cellphone . "' , '" . $phone . "' , UPPER('" . $street . "') , " . $number . " , UPPER('" . $municipality . "') , UPPER('" . $suburb . "') , '" . $state . "' , " . $cp . " , '" . $division . "' , UPPER('" . $pexperience . "') , UPPER('" . $experience . "') , UPPER('" . $lic . "') , '" . $cedulaLic . "' , UPPER('" . $institucionLic . "') , UPPER('" . $mae . "') , '" . $cedulaMae . "' , UPPER('" . $institucionMae . "') , UPPER('" . $doc . "') , '" . $cedulaDoc . "' , UPPER('" . $institucionDoc . "') , '" . $subidaN . "' , '" . $subidaC . "' , '" . $subidaP . "')");
                                    if ($ejecucion === TRUE) {
