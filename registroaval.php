        ...
        <div class="row g-0 h-100">
            <div class="col-lg-6 d-flex">
                <div class="content px-4 my-auto ">
                    ...
                    <p class="parrafo-aval">En la normateca se encuentra un arvhivo de nombre <span class="fw-bold">"Formato Pagaré"</span> y se debe de imprimir para ser llenado y firmado por el prestatario y por el aval.
                    </p>
                    <p class="parrafo-aval">Una vez compleatado se deberá escanear y guardar en un archivo PDF para poder subirlo en el apartado de<span class="fw-bold">"Formato Pagaré"</span>.

                    </p>
                        <br><br>

                        <p class="nota-aval">NOTA: El archivo solicitado se encuentra en la normateca con el nombre de "PAGARE2023". Debe 
