...
<body>
    <div class="row g-0 p-5 w-75 bg-light mx-auto text-center my-5">
        ...
        if (isset($_SESSION['NumEmpleado5'])) {
            ...
            $sql = "SELECT Nombres, ApellidoMat, ApellidoPat, NumEmpleado, IdBanco1, Clabe  FROM datosbancarios inner join empleado on datosbancarios.NumEmpleado2 = empleado.NumEmpleado inner join banco on banco.IdBanco = datosbancarios.IdBanco1 WHERE NumEmpleado2 = '$NumEmpleado' ";
        ...
        ?>
                ...
                <div class="p-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control text-center" id="clabe" value="" />
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="datosBancarios($NumEmpleado)">
                        Aceptar
                    </button>
                </div>
            <?php
                ...
                $Clabe = $row['Clabe'];
                $IdBanco = $row['IdBanco1'];
            ?>
                <div class="col p-3">
                    <label for="titular" class="form-label">Nombre TITULAR</label>
                    <input type="text" class="form-control text-center" id="titular" value="<?php echo $Nombres . " " . $ApellidoPat . " " . $ApellidoMat; ?>" disabled>
                </div>
                <div class="col p-3">
                    <div class="form-group">
                        <label for="Banco" class="form-label">Institución Bancaria</label>
                        <select class="form-control" id="Banco">
                            ...
                            ?>
                                <option><?php echo $opc['InstitucionBancaria'] ?></option>
                            <?php
                            endforeach
                            ?>
                ...
                <div class="p-3">
                    <label for="clabe" class="form-label">No. CLABE</label>
                    <div class="input-group">
                        <input type="text" class="form-control text-center" id="clabe" value="<?php echo $Clabe ?>" />
                        <span class="input-group-text" id="basic-addon2">
                            <abbr title="El número de cuenta son 18 dígitos, en caso de que el banco sea Banorte el número de cuenta son 10 dígitos "><i class="fa-solid fa-circle-info"></i></abbr>
                        </span>
                    </div>
