    ...
    <div class="row g-0 h-50 p-5">
        <div class="col-lg-7 d-flex">
            <div class="content px-3 my-auto">
                ...
                <marquee><h1 class="display-6"><em>Es importante tener la información bancaria actualizada o dada de alta antes de solicitar un préstamo.<em></h1></marquee>
                <ul>
                    <li>
        ...
        <div class="col-lg-5 d-flex bg-light">
            <div class="content mx-auto align-self-center px-4 my-5">
                <button type="button" class="btn btn-primary" style="width: 100%; height: 100px;" onclick=location.href="registroaval.html">CONOCE TU PODER CREDITICIO</button>
                <button type="button" class="btn btn-warning" style="width: 100%; height: 100px;" onclick=location.href="normateca.php">¿YA SOLICITASTE UN PRESTAMO? <br>¡CONOCE EL ESTATUS DE TUS PRESTAMOS!</button>
                <button type="button" class="btn btn-primary" style="width: 100%; height: 100px;" onclick=location.href="registroCA.php">PRESTAMO POR CAJA DE AHORRO</button>
                ...
                <button type="button" class="btn btn-primary" style="width: 100%; height: 100px;" onclick=location.href="registroaval.html">PRESTAMO POR AVAL</button>
            </div>
        </div>
    </div>
    <!-- </section>  -->
