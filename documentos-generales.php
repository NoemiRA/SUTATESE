                    ...
                    <div class="col-lg-6 d-flex">
                        <div class="content px-4 my-auto">
                            ...
                            <p class="parrafo-aval">
                                En esta sección se suben los documentos que se generaron con su información para inscribirse en la caja de ahorro. Dichos documentos  fueron creados cuando usted entró al apartado "Caja de Ahorro". Los documentos se encuentran  en su dispositivo y deben ser los siguientes: <span class="fw-bold"> "FORMATO CUOTA S.U.T.A.T.E.S.E.", "SOLICITUD DE APORTACIÓN A LA CAJA DE AHORRO".</span> Los 2 archivos deben ser haber sido impresos para poderlos firmar por usted y por el secretario general del SUTATESE. Una vez firmados se deben de escanear y guardar en un archivo PDF.
                            </p>
                            <p class="parrafo-aval">
                            ...
                            <br><br>
                            <p class="parrafo-aval">
                                Una vez generados y guardados los archivos que se muestran en la tabla de arriba, por favor súbalos en el apartado correspondiente con el nombre indicado en el documento.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex">
