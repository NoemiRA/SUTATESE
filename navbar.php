...
<nav class="navbar navbar-expand-xl bg-light ">
    <div class="container-fluid ">
        <div class="d-flex navbar-color ">
            ...
            ?>
                <a href="inicio.php" class="text-decoration-none" style="color: #ffffff;"><img src="resources\SUTATESE.png" class="me-3 mx-2 my-1" alt="" width="60" height="80">
                    <div class="my-auto">
            ...
            ?>
                <a href="admin.php" class="text-decoration-none" style="color: #ffffff;"><img src="resources\SUTATESE.png" class="me-3 mx-2 my-1" alt="" width="60" height="80">
                    <div class="my-auto">
                        <p class="fw-bold mb-0 ">SUTATESE</p>
                        <small>Sindicato Único de Trabajadores Académicos del Tecnológico de Estudios Superiores de
                            Ecatepec</small>
