function Saludo() {
  ...
  var fechaHoy = new Date().toLocaleString("ES", {
    weekday: "long",
    year: "numeric",
    month: "long",
    day: "numeric",
...
function alertaPrestamos() {
  swal(
    "¡PRESTAMO EN REVISIÓN!",
    'Para conocer el estatus del prestamo puedes visitar el apartado "CONOCE EL ESTATUS DE TU PRESTAMOS"',
    "success"
  );
}
...
function alertaCorreo() {
  swal(
    ...
    'Tu contraseña para accesar al sistema se enviará al correo electrónico proporcionado "FAVOR DE REVISARLO"',
    "success"
  );
}
